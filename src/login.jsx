...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white dark:bg-customDark text-gray-900 dark:text-gray-100">
      <div className="w-full max-w-4xl min-h-[800px] p-20 space-y-10 bg-white dark:bg-gray-900 rounded-xl shadow-md">
